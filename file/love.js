(function(window){
    ...
    Seed.prototype = {
        ...
        drawHeart: function() {
            ...
            ctx.save();
            ctx.fillStyle = color;
            ctx.shadowColor = 'rgba(232, 199, 126, 0.55)';
            ctx.shadowBlur = 18;
        ...
        drawText: function() {
            ...
            ctx.fillText("Just Because.", 28, 10);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.shadowColor = 'rgba(125, 63, 92, 0.25)';
            ctx.shadowBlur = 3;
        	ctx.moveTo(p.x, p.y);
    ...
    var bouquetPalette = [
        'rgb(245, 183, 200)', // blush pink
        'rgb(232, 199, 126)', // warm gold
        'rgb(216, 181, 226)', // lavender
        'rgb(240, 156, 176)', // rose
        'rgb(250, 214, 165)', // peach
        'rgb(201, 142, 166)'  // mauve
    ];

    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || bouquetPalette[random(0, bouquetPalette.length - 1)];
